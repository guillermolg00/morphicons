...
/* Brand glyphs from simple-icons (CC0), 24×24, fill currentColor. */
const REACT_LOGO =
    ...
    <div>
      <div className="overflow-hidden rounded-xl border border-hairline bg-code-bg shadow-card-lg">
        <div className="flex h-12 items-center justify-between gap-3 border-b border-white/10 px-2 sm:px-3">
          {/* biome note: intentionally a manual tabs pattern — 3 static tabs */}
          <div
            role="tablist"
      ...
      <p className="mt-3 text-sm text-body">
        That is the whole thing — in React, Vue or Svelte. No wrappers, no keys, no
        from/to pairs, no configuration. Swap the pair for any two icons above.
      </p>
    </div>
  );
}
